function graficapuenteCargaApp (app,xrield,ycard,rcarg,hcarg,xg,yg,zg,zc,nub,ov2)
...
if ov2==1
    ...
    plot3 (app.UIAxes,x14,y14,z14,'Color',[0.5 0.25 0]);
    ...
    plot3 (app.UIAxes,x14,y14,z15,'Color',[0.5 0.25 0]);
    
    plot3(app.UIAxes,[xg+rcarg, xg+rcarg],[yg, yg],[zc-hcarg/2, zc+hcarg/2],'Color',[0.5 0.25 0]);
    plot3(app.UIAxes,[xg+rcarg*cosd(30), xg+rcarg*cosd(30)],[yg+rcarg*sind(30), yg+rcarg*sind(30)],[zc-hcarg/2, zc+hcarg/2],'Color',[0.5 0.25 0]);
    plot3(app.UIAxes,[xg+rcarg*cosd(60), xg+rcarg*cosd(60)],[yg+rcarg*sind(60), yg+rcarg*sind(60)],[zc-hcarg/2, zc+hcarg/2],'Color',[0.5 0.25 0]);
    plot3(app.UIAxes,[xg, xg],[yg+rcarg, yg+rcarg],[zc-hcarg/2, zc+hcarg/2],'Color',[0.5 0.25 0]);
    plot3(app.UIAxes,[xg+rcarg*cosd(120), xg+rcarg*cosd(120)],[yg+rcarg*sind(120), yg+rcarg*sind(120)],[zc-hcarg/2, zc+hcarg/2],'Color',[0.5 0.25 0]);
    plot3(app.UIAxes,[xg+rcarg*cosd(150), xg+rcarg*cosd(150)],[yg+rcarg*sind(150), yg+rcarg*sind(150)],[zc-hcarg/2, zc+hcarg/2],'Color',[0.5 0.25 0]);
    plot3(app.UIAxes,[xg-rcarg, xg-rcarg],[yg, yg],[zc-hcarg/2, zc+hcarg/2],'Color',[0.5 0.25 0]);
    plot3(app.UIAxes,[xg+rcarg*cosd(210), xg+rcarg*cosd(210)],[yg+rcarg*sind(210), yg+rcarg*sind(210)],[zc-hcarg/2, zc+hcarg/2],'Color',[0.5 0.25 0]);
    plot3(app.UIAxes,[xg+rcarg*cosd(240), xg+rcarg*cosd(240)],[yg+rcarg*sind(240), yg+rcarg*sind(240)],[zc-hcarg/2, zc+hcarg/2],'Color',[0.5 0.25 0]);
    plot3(app.UIAxes,[xg, xg],[yg-rcarg, yg-rcarg],[zc-hcarg/2, zc+hcarg/2],'Color',[0.5 0.25 0]);
    plot3(app.UIAxes,[xg+rcarg*cosd(300), xg+rcarg*cosd(300)],[yg+rcarg*sind(300), yg+rcarg*sind(300)],[zc-hcarg/2, zc+hcarg/2],'Color',[0.5 0.25 0]);
    plot3(app.UIAxes,[xg+rcarg*cosd(330), xg+rcarg*cosd(330)],[yg+rcarg*sind(330), yg+rcarg*sind(330)],[zc-hcarg/2, zc+hcarg/2],'Color',[0.5 0.25 0]);
end