function graficaObstOmni (riesg,xcen,ycen,zcen,xrield,ptRies,ptColis,rcab,resf)
...
plot3 (x3,y3,z3,'Color',[0.9 0.9 0.9]);
...
plot3 (x4,y3,z4,'Color',[0.9 0.9 0.9]);

plot3([xcen+rcab, xrield+rcab],[ycen, ycen],[zaux, 1.05],'Color',[0.9 0.9 0.9]);
plot3([xcen+rcab*cosd(30), xrield+rcab*cosd(30)],[ycen+rcab*sind(30), ycen+rcab*sind(30)],[zaux, 1.05],'Color',[0.9 0.9 0.9]);
plot3([xcen+rcab*cosd(60), xrield+rcab*cosd(60)],[ycen+rcab*sind(60), ycen+rcab*sind(60)],[zaux, 1.05],'Color',[0.9 0.9 0.9]);
plot3([xcen, xrield],[ycen+rcab, ycen+rcab],[zaux, 1.05],'Color',[0.9 0.9 0.9]);
plot3([xcen+rcab*cosd(120), xrield+rcab*cosd(120)],[ycen+rcab*sind(120), ycen+rcab*sind(120)],[zaux, 1.05],'Color',[0.9 0.9 0.9]);
plot3([xcen+rcab*cosd(150), xrield+rcab*cosd(150)],[ycen+rcab*sind(150), ycen+rcab*sind(150)],[zaux, 1.05],'Color',[0.9 0.9 0.9]);
plot3([xcen-rcab, xrield-rcab],[ycen, ycen],[zaux, 1.05],'Color',[0.9 0.9 0.9]);
plot3([xcen+rcab*cosd(210), xrield+rcab*cosd(210)],[ycen+rcab*sind(210), ycen+rcab*sind(210)],[zaux, 1.05],'Color',[0.9 0.9 0.9]);
plot3([xcen+rcab*cosd(240), xrield+rcab*cosd(240)],[ycen+rcab*sind(240), ycen+rcab*sind(240)],[zaux, 1.05],'Color',[0.9 0.9 0.9]);
plot3([xcen, xrield],[ycen-rcab, ycen-rcab],[zaux, 1.05],'Color',[0.9 0.9 0.9]);
plot3([xcen+rcab*cosd(300), xrield+rcab*cosd(300)],[ycen+rcab*sind(300), ycen+rcab*sind(300)],[zaux, 1.05],'Color',[0.9 0.9 0.9]);
plot3([xcen+rcab*cosd(330), xrield+rcab*cosd(330)],[ycen+rcab*sind(330), ycen+rcab*sind(330)],[zaux, 1.05],'Color',[0.9 0.9 0.9]);
